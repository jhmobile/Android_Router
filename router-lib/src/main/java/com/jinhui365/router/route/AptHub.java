...
import com.jinhui365.router.interceptor.InterceptorTable;
import com.jinhui365.router.interceptor.TargetInterceptors;
...
public class AptHub {
    private static final String PACKAGE_NAME = "com.jinhui365.router";
    ...
    static Map<String, Class<? extends InterceptorImpl>> interceptorTable = new HashMap<>();
